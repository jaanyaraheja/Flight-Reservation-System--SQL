...
FROM FLIGHTS 
JOIN BOOKINGS ON FLIGHT_ID = FLIGHT_ID 
JOIN AIRLINES ON AIRLINE_ID = AIRLINE_ID 
...
FROM FLIGHTS 
JOIN BOOKINGS ON FLIGHTS.FLIGHT_ID = BOOKINGS.FLIGHT_ID 
GROUP BY FLIGHTS.FLIGHT_ID, FLIGHTS.ORIGIN_AIRPORT_ID, FLIGHTS.DESTINATION_AIRPORT_ID 
